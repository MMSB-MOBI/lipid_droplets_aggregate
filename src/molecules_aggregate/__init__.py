...
def load_system(mda_system, molecules_to_cluster, cluster_threshold, cluster_to_keep, membrane_molecule, slice_membrane_size, nb_frames):
    return system_lib.SystemIterator(mda_system, molecules_to_cluster, cluster_threshold, cluster_to_keep, membrane_molecule, slice_membrane_size, nb_frames)
